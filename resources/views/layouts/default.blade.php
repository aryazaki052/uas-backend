...
<head>
	...
	<title>Bali Tour Admin</title>
	<meta content='width=device-width, initial-scale=1.0, shrink-to-fit=no' name='viewport' />
	<link rel="" href="{{ asset ('back/assets/img/.ico') }}" type="image/x-"/>
  ...
  <script>
    WebFont.load({
        ...
        custom: {"families":["Flat", "Font Awesome 5 Solid", "Font Awesome 5 Regular", "Font Awesome 5 Brands", "simple-line-s"], urls: ['{!! asset("back/assets/css/fonts.min.css") !!}']},
        active: function() {
