...
<div class="page-inner mt--5">
	<div class="row">
		<div class="col-md-12">
            ...
            <a href="{{ route('tour.create') }}" class="btn btn-primary btn-sm ml-auto">Tambah</a>
					</div>
          {{-- <div class="dropdown">
          ...
          @endif
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                  ...
                  <tr>
                      <td style="max-width: 20px;">{{ $tours->judul }}</td>
                      <td><p>{!! $tours->desk !!}</p></td>
                      <td > Rp. {{ $tours->harga }},000</td>
                      <td><img src="{{ asset('uploads/' .$tours->gambar_tour) }}" width="100"></td>
                      <td>
                        <a href="{{ route('tour.edit', $tours->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-pen"></i></a>
                        <form action="{{ route('tour.destroy', $tours->id) }}" method="POST" class="d-inline" onsubmit="return confirmDelete();">
                          @csrf
                          @method('delete')
