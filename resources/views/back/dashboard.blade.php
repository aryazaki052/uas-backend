			...
			<div class="card card-stats card-round">
				<div class="card-body ">
					<div class="row align-items-center">
						<div class="col-">
							<div class="-big text-center -primary bubble-shadow-small">
		...
		<div class="col-sm-6 col-md-3">
			<div class="card card-stats card-round">
				<div class="card-body">
					<div class="row align-items-center">
						<div class="col-">
							<div class="-big text-center -info bubble-shadow-small">
		...
		<div class="col-sm-6 col-md-3">
			<div class="card card-stats card-round">
				<div class="card-body">
					<div class="row align-items-center">
						<div class="col-">
							<div class="-big text-center -success bubble-shadow-small">
		...
		<div class="col-sm-6 col-md-3">
			<div class="card card-stats card-round">
				<div class="card-body">
					<div class="row align-items-center">
						<div class="col-">
							<div class="-big text-center -secondary bubble-shadow-small">
