...
<head>
  ...
  <link rel="stylesheet" href="../post/card2.css" />
...
<body>
  ...
  <img src="../gambar/lagon2.jpg" style="width: 100%" />
  <header>
    <h1 class="judul mt-5 mb-5 text-center">Blue Lagoon Snorkeling Bali</h1>
  </header>
  <div class="mt-3 container">
    ...
    <h2>Things to do</h2>
    <p>
      This Bali Activity will start at 9.00 am from one of these following
      areas: Nusa Dua, Jimbaran, Uluwatu, Kuta, Legian, Seminyak, Canggu, or
      Sanur. We will wait for you at your lobby hotel, and we will drive you
      to the destination. If you are not staying in one of those areas, please
      inform us of your location in details.
      <br />
      <br />
      Please note that this Bali Activity is for at least 2 persons. If you
      are going to book this activity for one person only, you have to pay an
      additional charge of 50% of the cost.
      <br />
      <br />
      This activity is for those who love snorkeling so much. The location of
      doing this activity is Padang Bay, Karangasem. There are two best places
      to do snorkeling. They are Tanjung Jepun and Blue Lagoon. The clear view
      of underwater life is the best part of this activity. The nice warm day
      that is collaborated with the clear view of underwater life will
      complete your holiday in Bali. This activity will not only be a
      memorable experience but also Instagramable. This activity includes boat
      and snorkeling equipment, so you don’t need to worry about it. This
      activity will be ended by having lunch before going back to your hotel.
    </p>
    <section class="mt-5">
      ...
      <!-- <div class="itinerary">
          ...
          <ul>
            <li>
              ...
              – Morning pick up from your hotel (time can be adjusted)
            </li>
            <li>
            ...
            <li>
              <strong>15:00 AM</strong>
              – Campuhan Ridge
            </li>
            <li>
              <strong>16:30 AM</strong>
              – Central Ubud dan Market
            </li>
            <li>
              <strong>17:30 AM</strong>
              – Return
            </li>
          </ul>
        </div> -->
      ...
      <div class="inex">
        <div class="row">
          <div id="included" class="col-md-6 mb-3">
            ...
            <ul>
              <li>Boat for Snorkeling</li>
            </ul>
            <ul>
              <li>Activity Insurance</li>
            </ul>
            <ul>
              <li>All Ticket Fees</li>
            </ul>
            <ul>
              <li>Lunch</li>
            </ul>
      ...
      <div class="bring" id="gList">
        ...
        <ul>
          <li>Cash for Personal Purchase</li>
        </ul>
      </div>
    </section>
