...
$(document).ready(function(){
	...
	if(!minimize_sidebar){
		...
		if($('.wrapper').hasClass('sidebar_minimize')){
			...
			minibutton.html('<i class="-options-vertical"></i>');
		}
		...
		minibutton.on('click', function() {
			if (mini_sidebar == 1) {
				...
				minibutton.html('<i class="-menu"></i>');
				mini_sidebar = 0;
			} else {
	...
	if(!toggle_overlay_sidebar){
		...
		if($('.wrapper').hasClass('is-show')){
			...
			overlaybutton.html('<i class="-options-vertical"></i>');
		}
		...
		overlaybutton.on('click', function() {
			if (overlay_sidebar_open == 1) {
				...
				overlaybutton.html('<i class="-menu"></i>');
				overlay_sidebar_open = 0;
			} else {
